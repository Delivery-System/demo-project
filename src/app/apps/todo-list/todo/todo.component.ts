...
export class TodoComponent implements OnInit {
  ...
  form;
  todoArray = [
    { task : 'Meeting with Agant Team' , completed : false },
    { task : 'Follow the reports received' , completed : false },
    { task : 'Review Users Feedback' , completed : false },
    { task : 'Users Request Approval' , completed : false }
  ];
